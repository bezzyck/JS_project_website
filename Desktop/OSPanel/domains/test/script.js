...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      item.appendChild(status); // FormData
...
var modals = function modals() {
  ...
  function bindModal(trSelector, trModal, trClose) {
    ...
    var selector = document.querySelectorAll(trSelector),
        modal = document.querySelector(trModal),
        close = document.querySelector(trClose); // applies a callback to an array of data (modals)
